...
public class GetInvalidCredentialsMethod extends AbstractApiMethodV2 {
    public GetInvalidCredentialsMethod(int page) {
        replaceUrlPlaceholder("base_url", Configuration.getRequired("api_url"));
        replaceUrlPlaceholder("page", String.valueOf(page));
        replaceUrlPlaceholder("client_id", Configuration.getRequired("invalid_key"));
    }
}